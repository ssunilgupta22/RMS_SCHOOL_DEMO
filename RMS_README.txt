...
>>> Before running my_school.exe MySQL Server 5.5 need to install first,  
...
(otherwise my_school.exe shows error while running)

While Running FIRST TIME my_school.exe will setup mysql-5.5.46-win32 or mysql-5.5.46-winx64 , 
